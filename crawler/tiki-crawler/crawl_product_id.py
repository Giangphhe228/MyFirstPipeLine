...
headers = {
    ...
    'Referer': 'https://tiki.vn/search?q=camera&page=1',
...
params = {
    ...
    'aggregations': '2',
    'trackity_id': '24591e51-28eb-58ae-45d0-dac00534fe96',
    'q':  'camera',
    'page': '1',
    "is_cross_border" :"0"
}
...
if os.path.exists("F:\RnD\ETL\ctiki\productId_dtmtb.csv"):
    os.remove("F:\RnD\ETL\ctiki\productId_dtmtb.csv")
df.to_csv("F:\RnD\ETL\ctiki\productId_dtmtb.csv", encoding="utf-8-sig")
